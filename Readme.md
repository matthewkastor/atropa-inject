...
This package lives at: [https://npmjs.org/package/atropa-inject](https://npmjs.org/package/atropa-inject)

Source code available at: [https://github.com/matthewkastor/atropa-inject/](https://github.com/matthewkastor/atropa-inject/)
...
In the browser this module is attached to the global namespace `atropa`, which
 ...
 Include `./browser/atropa-inject_web.js` in your page and
 `atropa.inject` will be available in your page.
...
To run the browser tests open `browser/atropa-inject_tests.html` in your
...
If you alter the source in `src/atropa-inject.js` please run the
